...
import Couplace.social.handler.OAuthLoginFailureHandler;
import Couplace.social.handler.OAuthLoginSuccessHandler;
...
public class SecurityConfig {
    ...
    // ClientRegistrationRepository 빈 정의 (카카오, 구글, 네이버 OAuth2 클라이언트 설정)
    @Bean
        ...
        httpSecurity.
                ...
                .oauth2Login(oauth -> // OAuth2 로그인 기능에 대한 여러 설정의 진입점
                        oauth
                                ...
                                .clientRegistrationRepository(clientRegistrationRepository()) // 카카오 클라이언트 등록 추가
                );
