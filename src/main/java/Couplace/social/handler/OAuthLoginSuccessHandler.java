...
import Couplace.social.info.KakaoUserInfo;
import Couplace.social.info.NaverUserInfo;
import Couplace.social.info.OAuth2UserInfo;
import Couplace.social.repository.UserRepository;
import Couplace.social.info.GoogleUserInfo;
...
public class OAuthLoginSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws IOException {
        ...
        // 정보 추출
        String providerId = oAuth2UserInfo.getProviderId(); // 이제는 name을 providerId로 사용
        ...
        if (existUser == null) {
            ...
            user = UserEntity.builder()
                    ...
                    .name(name)
                    .provider(provider)
                    .providerId(providerId)  // providerId는 이제 'name'을 사용
                    .build();
